...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pinjam-kendaraans.update", [$pinjamKendaraan->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_start') ? 'is-invalid' : '' }}" type="text" name="date_start" id="date_start" value="{{ old('date_start', $pinjamKendaraan->date_start) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_end') ? 'is-invalid' : '' }}" type="text" name="date_end" id="date_end" value="{{ old('date_end', $pinjamKendaraan->date_end) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reason') ? 'is-invalid' : '' }}" type="text" name="reason" id="reason" value="{{ old('reason', $pinjamKendaraan->reason) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_hp') ? 'is-invalid' : '' }}" type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $pinjamKendaraan->no_hp) }}" required>
                @if($errors->has('no_hp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_return') ? 'is-invalid' : '' }}" type="text" name="date_return" id="date_return" value="{{ old('date_return', $pinjamKendaraan->date_return) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_done') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="is_done" value="0">
                    <input class="form-check-input" type="checkbox" name="is_done" id="is_done" value="1" {{ $pinjamKendaraan->is_done || old('is_done', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="is_done">{{ trans('cruds.pinjamKendaraan.fields.is_done') }}</label>
                </div>
                @if($errors->has('is_done'))
                    <span class="text-danger">{{ $errors->first('is_done') }}</span>
                @endif
