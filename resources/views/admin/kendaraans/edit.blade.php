    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.kendaraans.update", [$kendaraan->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $kendaraan->slug) }}">
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('servis_terakhir') ? 'is-invalid' : '' }}" type="text" name="servis_terakhir" id="servis_terakhir" value="{{ old('servis_terakhir', $kendaraan->servis_terakhir) }}">
