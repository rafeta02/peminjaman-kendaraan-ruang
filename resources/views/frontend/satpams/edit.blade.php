    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.satpams.update", [$satpam->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nip">{{ trans('cruds.satpam.fields.nip') }}</label>
                            <input class="form-control" type="text" name="nip" id="nip" value="{{ old('nip', $satpam->nip) }}" required>
                            @if($errors->has('nip'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama" id="nama" value="{{ old('nama', $satpam->nama) }}" required>
                            @if($errors->has('nama'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('nama') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_wa" id="no_wa" value="{{ old('no_wa', $satpam->no_wa) }}">
                            @if($errors->has('no_wa'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('no_wa') }}
                                </div>
