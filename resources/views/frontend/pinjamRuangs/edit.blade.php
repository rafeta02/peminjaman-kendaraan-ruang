    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.pinjam-ruangs.update", [$pinjamRuang->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="time_start" id="time_start" value="{{ old('time_start', $pinjamRuang->time_start) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="time_end" id="time_end" value="{{ old('time_end', $pinjamRuang->time_end) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $pinjamRuang->no_hp) }}" required>
                            @if($errors->has('no_hp'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('no_hp') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="penggunaan" id="penggunaan" required>{{ old('penggunaan', $pinjamRuang->penggunaan) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="borrowed_by_text" id="borrowed_by_text" value="{{ old('borrowed_by_text', $pinjamRuang->borrowed_by_text) }}">
